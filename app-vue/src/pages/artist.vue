...
<template>
    <div id="artistWorkspace" class="appPage">
        <Guide instructions = "<b>Change the header pattern and background color of this app.</b>">
            Our app is made of components, which are reusable building blocks of a site. <b>Vue Components</b> are HTML, CSS, and JS packed together under one <code><b>.vue</b></code> file.

            <br><br>
            You can write code for your own components, or import pre-made ones from <a href="https://madewithvuejs.com/ui-library"><u>open-source UI libraries</u></a>.
